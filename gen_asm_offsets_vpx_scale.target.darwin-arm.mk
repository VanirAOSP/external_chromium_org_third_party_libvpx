...
$(gyp_intermediate_dir)/vpx_scale_asm_offsets.o: $(LOCAL_PATH)/third_party/libvpx/unpack_lib_posix.sh $(GYP_TARGET_DEPENDENCIES)
	...
	$(hide)cd $(gyp_local_path)/third_party/libvpx; mkdir -p $(gyp_intermediate_dir); ../../third_party/libvpx/unpack_lib_posix.sh -d "$(gyp_intermediate_dir)" -f vpx_scale_asm_offsets.o -a "$(gyp_shared_intermediate_dir)/libvpx_asm_offsets_vpx_scale.a" -a "$(obj).$(TOOLSET)/third_party/libvpx/libvpx_asm_offsets_vpx_scale.a" -a "$(obj).$(TOOLSET)/Source/WebKit/chromium/third_party/libvpx/libvpx_asm_offsets_vpx_scale.a" -a "$(PWD)/$(call intermediates-dir-for, STATIC_LIBRARIES, libvpx_asm_offsets_vpx_scale)/libvpx_asm_offsets_vpx_scale.a" -r "$(PWD)/$(TARGET_AR)"
...
.PHONY: third_party_libvpx_gen_asm_offsets_vpx_scale_gyp_rule_trigger
third_party_libvpx_gen_asm_offsets_vpx_scale_gyp_rule_trigger: $(gyp_shared_intermediate_dir)/third_party/libvpx/vpx_scale_asm_offsets.asm
...
LOCAL_GENERATED_SOURCES := \
	third_party_libvpx_gen_asm_offsets_vpx_scale_gyp_rule_trigger
